...
exports.mnemonicToSeed = exports.mnemonicToEntropy = void 0;
...
Object.defineProperty(exports, "mnemonicToEntropy", { enumerable: true, get: function () { return bip39_2.mnemonicToEntropy; } });
Object.defineProperty(exports, "mnemonicToSeed", { enumerable: true, get: function () { return bip39_2.mnemonicToSeed; } });
/**
...
async function getMnemonic(entropy, mnemonicLength) {
    ...
    if (!mnemonicLength) {
        ...
        const seed = (await (0, bip39_1.mnemonicToSeed)(mnemonic)).toString('hex');
        return {
            mnemonic,
            seed,
        };
