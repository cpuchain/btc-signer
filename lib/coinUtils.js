...
function formatCoins(amount, decimals = 8) {
    return (0, bignumber_js_1.BigNumber)(String(amount))
        .div(10 ** decimals)
        .toString();
}
function parseCoins(amount, decimals = 8) {
    // todo: return bigint for sat
    return (0, bignumber_js_1.BigNumber)(amount)
        .times(10 ** decimals)
        .toNumber();
}
...
function getScriptType(script) {
    ...
    if (script[0] == bitcoinjs_lib_1.opcodes.OP_DUP && script[1] == bitcoinjs_lib_1.opcodes.OP_HASH160 && script[2] == 20) {
        return 'legacy';
    }
