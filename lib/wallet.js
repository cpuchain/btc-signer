...
class CoinWallet {
    ...
    getMaxSpendable(changeAddress, customFeePerByte, cachedBalance) {
        return __awaiter(this, void 0, void 0, function* () {
            const { inputAmounts, fees } = yield this.populateTransaction([], changeAddress, customFeePerByte, true, cachedBalance);
            return (0, coinUtils_1.parseCoins)(inputAmounts) - (0, coinUtils_1.parseCoins)(fees);
        });
    }
    populateTransaction(outputs, changeAddress, customFeePerByte, spendAll, cachedBalance) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    populateConsolidation(customFeePerByte, cachedBalance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield Promise.all(inputs.map((input) => __awaiter(this, void 0, void 0, function* () {
                const tx = yield this.populateTransaction([], undefined, undefined, true, new CoinBalance({
                    feePerByte,
                    utxos: input,
    ...
    sendTransaction(outputs, changeAddress, customFeePerByte, spendAll, cachedBalance) {
        return __awaiter(this, void 0, void 0, function* () {
            const coinTx = yield this.populateTransaction(outputs, changeAddress, customFeePerByte, spendAll, cachedBalance);
