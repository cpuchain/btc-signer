...
class CoinWallet {
    ...
    getMaxSpendable(changeAddress, customFeePerByte, cachedBalance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const inputBytes = (0, coinUtils_1.getBytes)(this.addrType) * inputs.length;
            const outputBytes = (0, coinUtils_1.getBytes)((0, coinUtils_1.getScriptType)(outputScript), false);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (change > fees && this.getChangeAddress()) {
                const output = {
                    ...
                    value: change,
                    bytes: (0, coinUtils_1.getBytes)(addrType, false),
                };
