...
class CoinWallet {
    ...
    populateTransaction(outputs_1) {
        return __awaiter(this, arguments, void 0, function* (outputs, { changeAddress, customFeePerByte, spendAll, deductFees, cachedBalance, } = {}) {
    ...
    populateConsolidation() {
        return __awaiter(this, arguments, void 0, function* ({ customFeePerByte, cachedBalance, } = {}) {
            const balance = cachedBalance || (yield this.getBalance());
            const feePerByte = customFeePerByte || balance.feePerByte;
