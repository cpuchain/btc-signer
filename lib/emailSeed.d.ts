...
export declare function generateHexWithId(id: string, password: string, thirdParams?: Array<string>, nonce?: number): Promise<string>;
/**
...
export declare function generateMnemonicWithId(id: string, password: string, thirdParams?: Array<string>, mnemonicLength?: number, nonce?: number): Promise<{
    hex: string;
    entropy: string;
    entropy2: string;
    mnemonic: string;
