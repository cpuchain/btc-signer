    ...
    estimateFee() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return Math.floor((0, utils_1.parseCoins)((parsedFee * this.feeMultiplier) / 1000));
            }
            catch (_a) {
                return Math.floor((0, utils_1.parseCoins)(this.feeFallback / 1000));
            }
        });
    }
    ...
    estimateFee() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const fallbackFee = (0, utils_1.parseCoins)(this.feeFallback / 1000);
