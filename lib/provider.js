...
class CoinProvider {
    ...
    getBlockNumber() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const resp = yield fetch(`${this.backend}/api/blocks/tip/height`, {
                method: 'GET',
            });
            ...
            return Number((_a = data.blockbook) === null || _a === void 0 ? void 0 : _a.bestHeight);
        });
    }
...
class MempoolProvider extends CoinProvider {
    ...
    getBlockNumber() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Number(yield resp.text());
        });
    }
    getUtxoInternal(address) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getUnspent(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const [blockHeight, utxos] = yield Promise.all([
                this.getBlockNumber(),
            ...
            return utxos
                ...
                var _a;
                // Pending UTXO would be NaN and would sorted first
                const height = Number((_a = utxo.status) === null || _a === void 0 ? void 0 : _a.block_height);
